...
function StatCard({ title, value, isCurrency = false }: StatCardProps) {
  ...
  return (
    <div className="flex h-32 w-64 flex-col justify-center rounded-xl border-2 border-black bg-zinc-100 p-6 shadow-[4px_4px_0px_0px_#000] dark:border-white dark:bg-zinc-900 dark:text-white dark:shadow-[4px_4px_0px_0px_#757373]">
...
export default async function AdminStatics() {
  ...
  if (!statistics) {
    return (
      <div className="border-2 border-black bg-zinc-100 p-6 shadow-[4px_4px_0px_0px_#000] dark:border-white dark:bg-zinc-900 dark:text-white dark:shadow-[4px_4px_0px_0px_#757373]">
