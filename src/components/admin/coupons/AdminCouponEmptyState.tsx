...
export default function AdminCouponEmptyState({
  ...
  return (
    <div className="rounded-xl border-2 border-black bg-zinc-100 p-8 text-center shadow-[4px_4px_0px_0px_#000] dark:border-white dark:bg-zinc-900 dark:shadow-[4px_4px_0px_0px_#757373]">
