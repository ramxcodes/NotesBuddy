      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="font-satoshi rounded-md border-2 border-black bg-white pl-10 font-bold text-black shadow-[4px_4px_0px_0px_#000] dark:border-white/20 dark:bg-zinc-900 dark:text-white dark:shadow-[4px_4px_0px_0px_#757373]"
          />
        </div>
      </div>
