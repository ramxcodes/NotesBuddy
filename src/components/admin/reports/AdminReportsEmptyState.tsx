...
export default function AdminReportsEmptyState({
  ...
  return (
    <div className="rounded-xl border-2 border-black bg-white p-12 text-center shadow-[4px_4px_0px_0px_#000] dark:border-white/20 dark:bg-zinc-800 dark:shadow-[4px_4px_0px_0px_#757373] flex flex-col items-center justify-center">
      ...
      <p className="font-satoshi mb-6 max-w-md text-zinc-600 dark:text-zinc-400 text-center">
        {hasFilters
