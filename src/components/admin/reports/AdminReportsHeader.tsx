                  ...
                  stats.topDomains.map((domain, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Badge
                          variant="outline"
                          className="border-2 border-black bg-white text-black dark:border-white dark:bg-black dark:text-white"
                        >
                          #{index + 1}
                        </Badge>
                      ...
                      <Badge
                        variant="secondary"
                        className="border-2 border-black bg-gray-100 text-black dark:border-white dark:bg-gray-800 dark:text-white"
                      >
