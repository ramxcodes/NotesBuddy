...
export default function AcademicFilters({
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="rounded-md border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_#000] dark:border-white/20 dark:bg-gray-800 dark:shadow-[8px_8px_0px_0px_#757373]">
